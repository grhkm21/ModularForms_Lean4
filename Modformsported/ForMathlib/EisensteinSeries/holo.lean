...
--     OpenEmbedding.toPartialHomeomorph_apply, UpperHalfPlane.coe, zpow_neg, inv_inj] at *
--   congr
--
...
theorem eisensteinSeries_SIF_Mdifferentiable {N : ℕ} (a: Fin 2 → ZMod N) (hk : 3 ≤ k) :
    MDifferentiable 𝓘(ℂ) 𝓘(ℂ) (eisensteinSeries_SIF a k).toFun :=
  eisensteinSeries_SIF_MDifferentiable hk a
