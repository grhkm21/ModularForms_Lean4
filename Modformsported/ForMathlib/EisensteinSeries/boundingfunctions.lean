...
-- This has been merged at NumberTheory/ModularForms/EisensteinSeries/UniformConvergence.lean
...
lemma  eisensteinSeries_TendstoLocallyUniformlyOn (k : ℤ) (hk : 3 ≤ k) (N : ℕ)
  ...
  ( fun (z : ℍ) => (eisensteinSeries_SIF a k).1 z) Filter.atTop :=
  eisensteinSeries_tendstoLocallyUniformly hk a
